...
export interface WorldConfig {
  ...
  difficulty:Difficulty; objects:SceneObjectDef[]; emoji?:string; theme?:string;
}
export interface WorldCard {
  id:string; name:string; arabic:string; description:string; emoji:string;
  status:'published'|'coming-soon'; vocabularyCount:number; difficulty:string;
}
